...
from zatca_erpgulf.zatca_erpgulf.purchase_createxml import (
    xml_tags,
...
def zatca_call_withoutxml(
    ...
    try:
        if not frappe.db.exist("Purchase Invoice", invoice_number):
...
def reporting_api_purchase_withoutxml(
    ...
    try:
        ...
        if not purchase_invoice_doc.custom_zatca_pos_name:
            frappe.throw(
