...
def reporting_api_xml_purchase_invoice(
...
def submit_purchase_invoice_withxmlqr(purchase_invoice_doc, file_path, invoice_number):
    ...
    try:
        ...
        reporting_api_xml_purchase_invoice(
            uuid1,
            encoded_hash,
        ...
        frappe.throw(f"Error in submitting Purchase invoice with XML and  QR: {str(e)}")
